 ...
 * generated in the me.arrhioui package. 
...
public class ObjectFactory {
    ...
    private final static QName _Conversion_QNAME = new QName("http://ws.arrhioui.me/", "conversion");
    private final static QName _ConversionResponse_QNAME = new QName("http://ws.arrhioui.me/", "conversionResponse");
    private final static QName _GetCompte_QNAME = new QName("http://ws.arrhioui.me/", "getCompte");
    private final static QName _GetCompteResponse_QNAME = new QName("http://ws.arrhioui.me/", "getCompteResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: me.arrhioui
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://ws.arrhioui.me/", name = "conversion")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.arrhioui.me/", name = "conversionResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.arrhioui.me/", name = "getCompte")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.arrhioui.me/", name = "getCompteResponse")
